...
<figure>
  ...
  <figcaption>A diagram summary of the process of a library service's annual statistics</figcaption>
</figure>

In this context, I believe the request is fair. Public libraries compile public data - so let's have those individual spreadsheets. It won't be aggregated, it won't be quality assured, and it won't have added-value analysis (e.g. population stats). But, it's still public data.
...
There is an exemption in FoI that means you may be able to refuse to answer if it's likely to commercially prejudice a person or organisation.
...
Many services argued that providing annual library stats to anyone other than CIPFA would be unfair to CIPFA, as CIPFA sell added value services based on that data.
...
As mentioned, CIPFA provide 'added value data analysis', 5 months after library services compile their data. For the individual data collected by libraries there are no market prices.
...
* The particular makeup/design of the dataset
...
In some cases services would have normally completed data, but didn't for 2020/2021. Fair enough, it was a difficult year and they had other things going on. So far over 15 have indicated this, although as I didn't ask, it's likely more.
...
2. An online form is distributed to library services at the end of this financial year. This will include questions that currently exist - but with relevant additions from the working group. All parties will promote this to library services across the UK.
