...
This isn't a particular criticism of that project, which had plenty of interesting analysis. This is the way most public library research is conducted, as one-off reports with an outcome in mind. Those commissioned to do the research have no particular interest in the long-term data maturity of the sector, and the library services involved tend to adopt a risk-averse attitude, only sharing their data for the purposes of the research.

More needs to be done by the sector to lead by example and recognise the huge task in changing the culture to an open by default one, and encouraging data reuse for service improvement.
