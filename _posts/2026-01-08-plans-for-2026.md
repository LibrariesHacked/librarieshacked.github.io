...
A recent [Libraries Connected commissioned report, conducted by Independent Mind](https://www.librariesconnected.org.uk/news/libraries-connected-publishes-new-report-library-loan-trends) gathered loans data from 34 library services and analysed it. However, the outputs from that project were 2 PDF print reports and an internal webinar for library services. No reusable data, or web content, or open engagement.
