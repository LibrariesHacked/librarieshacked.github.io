...
A common example of poor web content is links containing the text 'click here'. People do this because they've seen it a lot. But to 'click' is not always relevant, unless using a mouse. And the word 'here' is only valid when looking at the page. It makes assumptions about how users interact with web pages.
...
But it's one of many easy mistakes to make.

#### Use appropriate contrast for text

You may have a lovely monitor, making your website look great. But not everyone has the same hardware, or the same eyesight. Having a high contrast between text and background helps make text clear.
...
<figure class="align-center">
  ...
  <figcaption>Low contrast is often used for subtle design, but the contrast here is too low to read.</figcaption>
</figure>
...
A common mistake on library websites is to link to resources by their logo alone. To library staff, these are treasured and expensive e-resources. To the public it's a meaningless series of logos they're unlikely to follow.
...
<figure class="align-center">
  ...
  <figcaption>This series of links may look familiar to libraries, but will mean nothing to those who cannot see the images. They also won't mean much to anyone who doesn't know what they are.</figcaption>
</figure>

#### Don't use colour alone to convey meaning

Colours are great. But it shouldn't be necessary to recognise them. Services need to find different methods to convey meaning. For mobile library timetables, this means not having a calendar with dates coloured to indicate when the mobile library is visiting.
...
<figure class="align-center">
  ...
  <figcaption>Mobile library timetables often use colour to show what dates a mobile library route is running.</figcaption>
</figure>

Accessible design is better for everyone. Everyone wants well laid-out content, with plain language and descriptive links. All these things make a site easier to use, increase usage, and are win-win.

The best websites make mistakes. I'm no accessibility expert, and there's no substitute for user testing. By trying to follow guidelines, attempting good content, and publishing a statement, it shows that you care about trying to make things better.
...
I also noticed library information on council sites was more likely to be good. Content on library catalogue sites, away from council interference, was particularly bad. The greater the library involvement, the worse things were.

To try to eliminate council influence I looked again at library websites, but only where the website wasn't part of the council website. The test was simple, how many had an accessibility statement that would comply with the legislation?
...
There was at least one exception. Leeds Libraries are clearly putting a lot of effort into accessibility, and appear to be doing their best to work with suppliers to provide good websites.

### Who cares?

Do libraries care about any of this? Given current standards, no, with exceptions.

That's not malicious disregard for citizens. For users accessing physical libraries they will experience a top-class service with accessible options: good buildings, large print books, guidance on using the Internet, and more.

The problem is digital literacy. Web accessibility is seen as a 'tech' thing. Either the responsibility of IT, or website providers. Even though it affects users being able to access services.

There are other symptoms of digital literacy problems. Library online presences look like adapted print experiences. All reports from library organisations are still released as PDF files. That's not online publishing, it's print formats made available to download.
