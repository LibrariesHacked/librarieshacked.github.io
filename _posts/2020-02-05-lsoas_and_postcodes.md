...
- What does active membership mean? In the context of only keeping data as long as necessary, should we store data for people not considered active?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgyMzc2NzQ2OCwtMTYwMzc2NDcxNl19
-->