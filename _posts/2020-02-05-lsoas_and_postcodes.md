...
- What does active membership mean? In the context of only keeping data as long as necessary, should we even have the data of people not considered active?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4MTUwNjgwMCwtMTYwMzc2NDcxNl19
-->