...
- What does active membership mean? In the context of only keeping data as long as necessary, should we store records for people not considered active?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTcxNDAyMzIsLTE2MDM3NjQ3MTZdfQ
==
-->