...
- What does active membership mean? In the context of only keeping data as long as necessary, should we store records for people we don't consider as active?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwODg2NTYyMiwtMTYwMzc2NDcxNl19
-->